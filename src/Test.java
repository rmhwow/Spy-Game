...
//
//		SpyGraph t = new SpyGraph();
//
//		t.addGraphNode("a");
//		t.addGraphNode("b");
//		t.addGraphNode("c");
//
//		GraphNode aNode = t.getNodeFromName("a");
//
//		t.addEdge("a", "b", 1);
//		t.addEdge("b", "c", 1);
//
//		System.out.println("a neighbor is c == " + aNode.isNeighbor("c"));
//
//		Iterator<String> bs = t.getNodeFromName("a").getNeighborNames();
//
//		while(bs.hasNext()){
